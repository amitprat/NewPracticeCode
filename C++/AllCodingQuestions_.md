...
- A similar variant of this question is asked at FB. This can easily be solved by considering a+b+(-c) = 0. And hence, when looking for rem sum, we don't have to do 0-(a+b) but just directly (a+b) exists in map or not.
```
https://careercup.com/question?id=5708120205557760
